...
import Group26 from '../static/Group 26.png'
import Group27 from '../static/Group 27.png'
...
<link rel="stylesheet" href="https://myapiembedbot-9fe68cda24da.herokuapp.com/index-9zFeCT1e.css"></link>
   ...
   <div className="my-8 text-helvetica-neue container">
      ...
      <p className="text-gray-600 font-medium">
        See your live bot to the bottom left. Click + to get started. 
        We recommend users ask their bot the following questions as a hygiene requirement:
      </p>
      <ul className=" text-helvetica-neue font-medium  mt-4">
...
<button className='mt-8 mb-8 border border-gray-500 text-gray-500 px-4 py-2 rounded hover:border-blue-500 hover:text-blue-500'  onClick={moveToIntegration}>
  Installation Guide
</button>
